...
const EmptyCartInner = () => {
    const router = useRouter();
    const goBrowse = useCallback(() => router.push("/shoplist"), [router]);
    ...
    return (
        <div className="text-center py-16 sm:py-20 rounded-2xl bg-white dark:bg-gray-800/80 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700/60">
            ...
            <h3 className="mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">Your cart is empty</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400 max-w-sm mx-auto">
                Looks like you haven&apos;t added any items to your cart yet. Start shopping to fill it up!
            </p>
            <Button variant="dark" className="mt-8" onClick={goBrowse}>
                Browse Products
            </Button>
        </div>
    );
...
export const EmptyCart = memo(EmptyCartInner);